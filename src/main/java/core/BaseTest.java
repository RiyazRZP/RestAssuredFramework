...
public class BaseTest {
    ...
    public static void LogBeforeMethod(ITestResult result) {
        //final Logging log = Logging.getInstance();
        System.out.println("Test Case Execution Started >>>>>>>>>>>>>>>>>>>>>>>");
        ExtentReport.extentlog = ExtentReport.extentreport.startTest(result.getMethod().getMethodName(), "validating this testCase :"+result.getMethod().getMethodName());
